...
#define wb_robot_init() do{setvbuf(stdout, NULL, _IONBF, 0); setvbuf(stderr, NULL, _IONBF, 0); wb_robot_init_msvc()}while(0)
#endif
...
#define wb_robot_step(d) do{fflush(NULL); wb_robot_step(d)}while(0)
#endif
